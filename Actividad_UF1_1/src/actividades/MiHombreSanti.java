...
public class MiHombreSanti {
    ...
    private static final int[] edades = { 50, 60, 45, 45 }; // Debes definir las edades
    private static final String[] estudios = { "Licenciatura", "Licenciatura", "Licenciatura", "Doctorado" }; // Debes definir los estudios
